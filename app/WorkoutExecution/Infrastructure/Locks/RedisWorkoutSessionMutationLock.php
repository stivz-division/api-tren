...
final readonly class RedisWorkoutSessionMutationLock implements WorkoutSessionMutationLock
{
    ...
    public function execute(UserId $userId, Closure $callback): mixed
    {
        $lock = $this->locks->lock(
            'workout-execution:user:'.$userId->value,
            $this->lockSeconds,
        );
        ...
        try {
            ...
            throw new WorkoutSessionMutationInProgress($exception);
        }
